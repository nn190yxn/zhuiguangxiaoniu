...
强调10年级（初一）是动作模式纠偏的最后窗口期。
**不要说\"请联系课程顾问\"（已到店测试），直接说\"建议立即开始专项纠正课\"。**

---

格式要求：
1. 使用HTML标签（<h3>、<p>、<ul>、<table>等）美化结构
2. 重要数据用<strong>或<span style=\"color: #e74c3c\">突出
3. 许体用Arial或微软雅黑，字号14-16px
4. 适合A4纸打印（内容简洁，排版美观）
5. 不提及AI、大模型、系统生成等字眼
6. 以专业教练口吻撰写，语气真诚、有紧迫感',
