...
try {
    [$userId, $user, $operatorStaff] = adminRequirePermission('staff.offboard');
    ...
    $result = $service->offboard($staffId, $input, $operatorUser, $operatorStaff ?: []);
    jsonResponse(0, '员工离职归档成功', $result);
    ...
    error_log('[admin.staff.offboard] ' . $error->getMessage());
    jsonResponse(500, '员工离职归档失败', null);
}
