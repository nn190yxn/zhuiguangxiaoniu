...
try {
    ...
    $result = (new WorkloadDailyTrackingService($pdo))->penaltyList(appRequireStaffContext(), $_GET);
    ...
    appLogEvent('admin.workload.penalty_list_error', ['error' => $e->getMessage()]);
    jsonResponse(500, '获取处罚清单失败');
}
