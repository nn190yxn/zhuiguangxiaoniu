...
final class IdentityContextService
{
    ...
    public function current(int $userId, array $staffContext, ?array $staff): array
    {
        ...
        return [
            ...
            'staff_name' => (string)($staffContext['name'] ?? ($staff['name'] ?? '')),
            'role' => (string)($staffContext['role'] ?? 'staff'),
            'role_name' => (string)($staffContext['role_name'] ?? ($staffContext['role'] ?? 'staff')),
            'store_id' => isset($staffContext['store_id']) ? (int)$staffContext['store_id'] : null,
            'store_name' => (string)($staffContext['store_name'] ?? ''),
