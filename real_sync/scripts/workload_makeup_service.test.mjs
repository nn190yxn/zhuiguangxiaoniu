...
test('[validates 2.2, 2.3] makeup is available only for yesterday through the next midnight', () => {
  ...
  assert.equal(canMakeUp({ businessDate: '2026-08-11', now: '2026-08-13T00:00:00' }), false);
  assert.equal(canMakeUp({ businessDate: '2026-08-10', now: '2026-08-12T12:00:00' }), false);
  ...
  assert.match(makeupService, /\+2 days/);
});
