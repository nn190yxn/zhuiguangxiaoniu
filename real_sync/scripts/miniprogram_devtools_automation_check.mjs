...
export const MAIN_JOURNEY_STEPS = Object.freeze([
  ...
  { id: 'policy', route: 'pages/policy/list', action: 'open_policy', assertions: ['relative_api', 'acknowledge_policy'] },
  { id: 'notifications', route: 'pages/notifications/list', action: 'open_notifications', assertions: ['unread_count', 'detail_navigation'] },
  { id: 'learning', route: 'pages/learning/list', action: 'open_learning', assertions: ['course_list', 'lesson_detail'] },
  { id: 'knowledge', route: 'pages/knowledge/list', action: 'open_knowledge', assertions: ['media_descriptor', 'progress_write'] },
  { id: 'exam', route: 'pages/exam/exam', action: 'open_exam', assertions: ['assignment_idempotency', 'save_submit'] },
  { id: 'pass', route: 'pages/pass/map', action: 'open_pass', assertions: ['stage_id', 'detail_navigation'] },
  { id: 'points', route: 'pages/points/index', action: 'open_points', assertions: ['checkin', 'exchange_idempotency'] },
  { id: 'workload', route: 'pages/workload/index', action: 'open_workload', assertions: ['state_version', 'media_upload'] },
  { id: 'reminder', route: 'pages/reminder/gate', action: 'open_reminder', assertions: ['subscribe_message', 'recorded_result'] },
