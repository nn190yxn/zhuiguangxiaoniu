...
- [ ] 10. 阶段检查点：隔离摄取验收
  ...
  - 2026-08-26 本地门禁已通过：44 项知识卡专项测试中 41 通过、3 环境性跳过；隔离包 1417 条均为 isolated。生产只读 dry-run 因本机无 PHP 且 SSH 公钥不可用未执行，详见 `docs/ops/2026-08-26-knowledge-card-phase2-task10-local-gate.md`。
