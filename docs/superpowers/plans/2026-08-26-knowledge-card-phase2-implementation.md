...
- [ ] 10. 阶段检查点：隔离摄取验收
  ...
  - 2026-08-26 本地门禁已通过：44 项知识卡专项测试中 41 通过、3 环境性跳过；隔离包 1417 条均为 isolated。生产预检确认旧基线仍为 23 分类/194 知识/2 进度/9 演练，二期 schema 表不存在；dry-run 在 `knowledge_import_batches` preflight 处停止，详见 `docs/ops/2026-08-26-knowledge-card-phase2-task10-local-gate.md`。
